...
export const meta: ArticleMeta = {
  ...
  description: "Magnesium is involved in over 300 enzymatic reactions and is one of the most important minerals for hormonal health. Learn how it supports PMS, cramps, sleep, blood sugar, thyroid, and more — and which form to take.",
...
<li><strong>Processed food diet:</strong> Refined grains, sugar, and ultra-processed foods are nearly devoid of magnesium. When these foods displace whole grains, legumes, nuts, seeds, and leafy greens in the diet, magnesium intake drops sharply.</li>
<li><strong>Chronic stress:</strong> This is a major driver that is often overlooked. Stress triggers the release of cortisol and adrenaline, and both of these hormones increase urinary magnesium excretion — meaning you literally excrete more magnesium when you are stressed. And because low magnesium makes the stress response more reactive, this becomes a self-perpetuating cycle.</li>
<li><strong>Alcohol consumption:</strong> Even moderate alcohol intake increases renal magnesium excretion. Regular alcohol use is a meaningful contributor to depletion over time.</li>
<li><strong>Certain medications:</strong> Proton pump inhibitors (PPIs) impair magnesium absorption from the gut. Diuretics increase urinary excretion. Oral contraceptives have been associated with reduced magnesium levels in some research. If you take any of these, your baseline risk for deficiency is higher.</li>
...
<p>Research consistently shows that women with PMS have significantly lower red blood cell magnesium levels than women without PMS — and that supplementation can reduce PMS severity. The mechanism makes sense: magnesium is required for the synthesis of serotonin (the neurotransmitter most associated with mood stability) and supports the activity of GABA, the brain's primary inhibitory neurotransmitter responsible for calm and relaxation. Low magnesium means less serotonin and less GABA activity, which translates directly into the anxiety, irritability, low mood, and overwhelm that characterize luteal phase PMS. Magnesium glycinate is the form I most commonly recommend for this purpose — it is highly absorbable, does not cause loose stools, and the glycine component has additional calming effects of its own. You can find my specific product picks in my <a href="https://us.fullscript.com/protocols/nicolejardim-magnesium-options" target="_blank" rel="noopener noreferrer" class="article-link">Magnesium Options Protocol</a> on Fullscript.</p>
...
<td>Sleep, anxiety, PMS, muscle tension, general daily use</td>
<td>Most absorbable form with least laxative effect. The glycine component adds calming benefits. Best choice for most women.</td>
</tr>
<tr>
<td><strong>Magnesium citrate</strong></td>
<td>Constipation, general supplementation</td>
<td>Good absorption. More laxative effect than glycinate — useful for sluggish bowels, but reduce dose if stools become too loose.</td>
</tr>
<tr>
<td><strong>Magnesium malate</strong></td>
<td>Energy support, fibromyalgia, muscle pain</td>
<td>Malic acid plays a role in the Krebs cycle (energy production). Good for women with fatigue and muscle aches.</td>
</tr>
<tr>
<td><strong>Magnesium threonate</strong></td>
<td>Brain health, cognitive function, memory</td>
<td>The only form shown to cross the blood-brain barrier effectively. Excellent if brain fog, cognitive decline, or neurological support is a priority.</td>
</tr>
<tr>
<td><strong>Magnesium oxide</strong></td>
<td>Avoid for general use</td>
<td>Poorest absorption of all forms (around 4%). Very common in cheap supplements. Use magnesium citrate instead if you want the laxative effect.</td>
</tr>
</tbody>
</table>
<p>My default recommendation for most women is <strong>magnesium glycinate</strong> for daily use — especially for PMS, sleep, anxiety, and general hormonal support. If constipation is a specific concern, magnesium citrate alone or a blend of citrate and glycinate works well. Magnesium malate and threonate are more targeted and can be layered in if energy or cognitive symptoms are prominent.</p>
<h2>How Much Magnesium to Take</h2>
<p>The latest research suggests that the optimal daily dose of magnesium for adults is around <strong>300–400 mg of elemental magnesium per day</strong>. Some individuals with significant deficiency, high stress loads, or specific therapeutic goals may require more, but this range covers most women's needs.</p>
<p>A few practical points on dosing:</p>
<ul>
<li><strong>Split your doses.</strong> Magnesium is better absorbed in divided doses than in a single large dose. Taking 150–200 mg in the afternoon and 150–200 mg in the evening is more effective and gentler on the gut than taking 400 mg at once.</li>
<li><strong>Start low and build up.</strong> If you are new to magnesium or sensitive to the laxative effect of citrate, start with 100–150 mg and increase gradually over one to two weeks. Loose stools are the most common reason women stop supplementing — starting low avoids this.</li>
<li><strong>Evening dosing for sleep.</strong> If your primary goal is better sleep, take the larger of your two doses 30–60 minutes before bed. For magnesium glycinate specifically, the typical dose for sleep support is 200–400 mg in the evening.</li>
...
<li><strong>Pumpkin seeds:</strong> one ounce delivers around 150 mg — one of the highest food sources available</li>
<li><strong>Almonds and cashews:</strong> one ounce provides 76 mg and 74 mg respectively</li>
<li><strong>Leafy greens</strong> (spinach, Swiss chard, collard greens): one cup cooked spinach provides around 157 mg</li>
<li><strong>Legumes</strong> (black beans, edamame, lentils): a half cup of cooked black beans provides around 60 mg</li>
<li><strong>Avocado:</strong> a whole avocado provides approximately 58 mg, along with potassium and healthy fats</li>
<li><strong>Whole grains</strong> (quinoa, brown rice, oats): a cup of cooked quinoa provides around 118 mg</li>
...
<p>Magnesium toxicity from supplementation is rare in healthy adults with normal kidney function because the kidneys efficiently excrete excess magnesium. The first and most common sign that you are taking too much is loose stools or diarrhea — the body's way of clearing excess through the gut. If this happens, reduce your dose by half and build back up more slowly. Switching from magnesium citrate to glycinate also reduces laxative effects significantly at the same dose.</p>
<p>True toxicity — involving low blood pressure, slowed heart rate, or extreme lethargy — is generally only seen at very high supplemental doses (over 5,000 mg per day) or in individuals with impaired kidney function. If you have kidney disease, consult with your doctor before supplementing with magnesium.</p>
<div class="article-cta-box">
<h3>Not sure where to start with hormonal symptoms?</h3>
<p>Take the free Hormone Health Assessment to get a personalized protocol based on your specific symptoms and cycle — including targeted supplement guidance. It takes just a few minutes and gives you a clear place to begin.</p>
